...
browse_button = browser.find_element_by_css_selector('div.inner-gaps:nth-child(17) > input:nth-child(2)')
browse_button.send_keys('/Users/XavierElon/Documents/treehouses/planet-scraping/treehouses.zip')
...
subject = browser.find_element_by_css_selector('#mat-select-2').click
